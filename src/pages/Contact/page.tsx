...
import { Send, Forward, Mail,Phone } from "lucide-react";
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4 p-4 rounded-xl backdrop-blur-md bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300">
                  ...
                  <div>
                    ...
                    >
                      <a href='mailto:hossein1379akbari@gmail.com'>
                      hossein1379akbari@gmail.com
                      </a>
                    </p>
                  </div>
                </div>
                <div className="flex items-center space-x-4 p-4 rounded-xl backdrop-blur-md bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300">
                  ...
                  <div>
                    ...
                    >
                       <a href='https://t.me/HosseinAkbari2000'>
                      @Hossein1379Akbari2000
                      </a>
                    </p>
                  </div>
                </div>
                <div className="flex items-center space-x-4 p-4 rounded-xl backdrop-blur-md bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300">
                  ...
                  <div>
                    ...
                    >
                      <a href='tel:+989010540925'>09010540925</a>
                    </p>
                  </div>
                </div>
              </div>
