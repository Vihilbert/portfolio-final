...
import { Briefcase, Calendar, Code,BrainCircuit } from "lucide-react";
...
export default function ProfessionalJourney() {
    ...
    >
      ...
      <div className="@container mx-auto max-w-5xl px-6 relative">
        <div className="text-center">
          ...
          "تبدیل ایده‌ها به واقعیت دیجیتال، پروژه به پروژه"
          </p>
        </div>
        <motion.div
  ...
  company="فریلنس"
  period="بهمن 1402 - حال حاضر"
  description="طراحی و توسعه وب‌سایت‌های کاربرپسند با استفاده از HTML، CSS، JavaScript و ReactJS. ایجاد کامپوننت‌های UI با کدهای قابل استفاده مجدد. همکاری با تیم بک‌اند برای ادغام API‌ها."
  icon={<Code />}
/>

<ExperienceCard
  title="برنامه‌نویس هوش مصنوعی"
  company="فریلنس"
  period="آبان 1401 - حال حاضر"
  description="توسعه مدل‌های هوش مصنوعی و الگوریتم‌ها برای پردازش داده‌ها و تحلیل اطلاعات. استفاده از Python و تکنیک‌های یادگیری ماشین."
  icon={<BrainCircuit />}
/>

<ExperienceCard
  title="برنامه‌نویس پردازش داده‌ها"
  company="شرکت بهیار صنعت سپاهان، اصفهان"
  period="فروردین 1401 - آبان 1401"
  description="توسعه الگوریتم‌ها و راه‌حل‌های نرم‌افزاری برای پردازش داده‌ها و بهبود تجزیه و تحلیل آن‌ها با استفاده از Python و C++."
  icon={<Briefcase />}
/>
